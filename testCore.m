function [recalls, allRecalls, results]= testCore(db, qFeat, dbFeat, varargin)
    opts= struct(...
        'nTestSample', inf, ...
    ...
    [res, recalls, results]= recallAtN( searcherRAW, db.numQueries,  @(iQuery, iDb) db.isPosQ(iQuery, iDb), opts.recallNs, opts.printN, opts.nTestSample );
